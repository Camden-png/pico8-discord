...
import os, re, sys, time, asyncio, platform, subprocess as sp
...
def get():
    ...
    for line in lines:
        ...
        if line.startswith("Token"): g.token = string
        elif line.startswith("Directory to application:"): g.directory_application = string
